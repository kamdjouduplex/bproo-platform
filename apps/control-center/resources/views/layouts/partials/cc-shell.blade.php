...
<aside class="cc-sidebar" :class="{ 'cc-sidebar--open': sidebarOpen }">
    ...
    <nav class="cc-sidebar__nav" aria-label="Navigation Control Center">
        ...
        <div class="cc-sidebar__group">
            ...
            <a href="{{ route('system.desktop.releases') }}" class="cc-nav__link {{ $navActive('system.desktop.releases') }}" @click="sidebarOpen = false">
                <span class="cc-nav__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path stroke-linecap="round" stroke-linejoin="round" d="M7 10l5 5 5-5"/><path stroke-linecap="round" d="M12 15V3"/></svg>
                </span>
