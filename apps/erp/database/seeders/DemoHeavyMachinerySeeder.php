...
class DemoHeavyMachinerySeeder extends Seeder
{
    ...
    private function seedClients(): void
    {
        $clients = [
            ...
            [
                'code' => 'CLI-DEMO04',
                'name' => 'Mines de Nkongsamba SARL',
                'type' => 'company',
                'email' => 'achats@mines-nkongsamba.cm',
                'phone' => '+237 6 91 20 44 18',
                'address' => 'Route de Melong, Nkongsamba',
                'tax_id' => 'M667788990',
                'rccm' => 'RC/NKS/2018/B/0441',
                'niu' => 'M667788990012A',
                'bp' => 'BP 310 Nkongsamba',
                'credit_limit' => 8000000,
                'payment_method' => 'bank_transfer',
                'price_tier' => 'wholesale',
                'notes' => 'Parc d’engins miniers — turbo, radiateurs, filtres.',
            ],
            [
                'code' => 'CLI-DEMO05',
                'name' => 'Agro Transport Centre',
                'type' => 'company',
                'email' => 'logistique@agro-centre.cm',
                'phone' => '+237 6 55 12 09 77',
                'address' => 'Marché de Mfoundi, Yaoundé',
                'tax_id' => 'M445566778',
                'rccm' => 'RC/YDE/2022/B/1180',
                'niu' => 'M445566778012B',
                'bp' => 'BP 220 Yaoundé',
                'credit_limit' => 1500000,
                'payment_method' => 'mobile_money',
                'price_tier' => 'semi_wholesale',
                'notes' => 'Camions de collecte agricole — freinage et embrayage.',
            ],
            [
                'code' => 'CLI-DEMO06',
                'name' => 'Bâtir Plus Travaux Publics',
                'type' => 'company',
                'email' => 'direction@batirplus.cm',
                'phone' => '+237 6 72 88 01 45',
                'address' => 'Bonanjo, Douala',
                'tax_id' => 'M112233445',
                'rccm' => 'RC/DLA/2017/B/0902',
                'niu' => 'M112233445012C',
                'bp' => 'BP 778 Douala',
                'credit_limit' => 3500000,
                'payment_method' => 'bank_transfer',
                'price_tier' => 'wholesale',
                'notes' => 'Chantiers routiers — pièces CAT et Cummins.',
            ],
        ];
