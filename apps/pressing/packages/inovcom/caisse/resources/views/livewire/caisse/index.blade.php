                                ...
                                @foreach ($sessions as $session)
                                    ...
                                    <tr>
                                        ...
                                        <td class="caisse-export-cell">
                                            @if ($canView)
                                                <button type="button" class="btn btn-secondary btn-sm" wire:click="exportSessionPdf({{ $session->id }})">PDF</button>
                                                <button type="button" class="btn btn-secondary btn-sm" wire:click="exportSessionExcel({{ $session->id }})">Excel</button>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
