@props(['icon' => 'cog', 'class' => ''])
@php
    // Heroicons outline (24) — une clé unique par usage menu autant que possible.
    $icons = [
        ...
        'credit-card' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 8a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm0 2h18M7 15h2m4 0h2"/>',
        ...
        'calculator' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m-6 4h6m-6 4h2m4 0h2M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"/>',
        ...
        'arrow-uturn-left' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"/>',
        ...
        'beaker' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 7a4 4 0 01-6 0L8 4z"/>',
        ...
        'gift' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h3.5a2.5 2.5 0 012.5 2.5V8m0 0h2V6.5A2.5 2.5 0 0115.5 4H19a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8M12 8v12"/>',
    ];
    $path = $icons[$icon] ?? $icons['cog'];
@endphp
<svg class="sidebar-icon {{ $class }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">{!! $path !!}</svg>
