...
<head>
    ...
    <meta name="description" content="Pressing — ERP de gestion de pressing. Réception, workflow, paiements, multi-agences.">
    <title>Pressing — ERP de gestion de pressing</title>
...
<body class="landing">
    ...
    <header class="landing-header">
        <div class="landing-header-inner">
            <a href="{{ url('/') }}" class="landing-logo">{{ config('app.name', 'Pressing') }}</a>
