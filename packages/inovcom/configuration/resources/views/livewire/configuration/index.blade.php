        ...
        <div style="display: grid; gap: 16px;">
            ...
            <div>
                ...
                <select class="input" wire:model="timezone">
                    ...
                    <option value="Africa/Bamako">Afrique / Bamako (UTC)</option>
                    <option value="Africa/Ouagadougou">Afrique / Ouagadougou (UTC)</option>
                    <option value="Africa/Lome">Afrique / Lomé (UTC)</option>
                    <option value="Africa/Accra">Afrique / Accra (UTC)</option>
                    ...
                    @if ($timezone !== '' && ! in_array($timezone, [
                        ...
                        'Africa/Abidjan', 'Africa/Dakar', 'Africa/Bamako', 'Africa/Ouagadougou', 'Africa/Lome',
                        'Africa/Accra', 'Africa/Johannesburg', 'Africa/Nairobi', 'Europe/Paris', 'UTC',
                    ], true))
                        <option value="{{ $timezone }}">{{ $timezone }}</option>
                    @endif
                </select>
                <p style="font-size: 11px; color: #9ca3af; margin-top: 6px;">
                    S’applique uniquement à ce magasin (présence, sauvegardes, impressions). Les autres tenants gardent leur propre fuseau.
                </p>
