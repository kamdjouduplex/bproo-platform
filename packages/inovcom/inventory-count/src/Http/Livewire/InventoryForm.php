...
class InventoryForm extends Component
{
    ...
    public function mount(?StockCount $stock_count = null): void
    {
        ...
        // Load lines if count is in progress or completed
    ...
    public function startCount(): void
    {
        ...
        try {
            $inventoryService = app(InventoryService::class);
            $inventoryService->startStockCount($this->countId);
            $this->loadLines();
    ...
    public function updateLine(int $lineIndex): void
    {
        ...
        try {
            $inventoryService = app(InventoryService::class);
            $inventoryService->updateCountLine(
                $this->countId,
                $line['item_id'],
    ...
    public function completeCount(bool $applyAdjustments = true): void
    {
        ...
        try {
            $inventoryService = app(InventoryService::class);
            $inventoryService->completeStockCount($this->countId, $applyAdjustments);
