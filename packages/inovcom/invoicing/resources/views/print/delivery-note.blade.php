        ...
        <table class="lines-table">
            <thead>
                <tr>
                    ...
                    <th style="width:{{ $showPrices && $showDiscounts ? '28%' : ($showPrices ? '36%' : '64%') }}">Référence / Article</th>
            ...
            <tbody>
                ...
                @php
                    ...
                    // Prix seuls : P.U. brut. Avec remises : P.U. = net (comme devis/facture) + colonne Remise.
                    $puDisplay = $showDiscounts ? $puNet : (float) ($line['unit_price'] ?? 0);
                    ...
                    $lineNo = (int) ($line['line_number'] ?? 0) ?: (($i + 1) * 10);
                @endphp
                <tr>
                    ...
                    @if ($showPrices)
                        <td class="num">{{ fmt_num($puDisplay, 2) }}</td>
                        @if ($showDiscounts)
