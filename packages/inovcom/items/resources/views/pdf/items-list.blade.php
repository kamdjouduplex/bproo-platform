...
@php
    ...
    $rows = $rows ?? [];
    $canViewCost = (bool) ($canViewCost ?? false);
    $currency = currency_label($settings['currency'] ?? null);
@endphp
            ...
            <div class="doc-box">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="doc-title">Catalogue</td>
                    </tr>
                </table>
            </div>
        </td>
...
<table class="data">
    <thead>
        <tr>
            ...
            <th style="width:{{ $canViewCost ? '24%' : '30%' }};">Désignation</th>
            <th style="width:12%;">Catégorie</th>
            <th style="width:10%;">Marque</th>
            <th style="width:8%;">Unité</th>
            <th class="right" style="width:10%;">P.V.</th>
            @if ($canViewCost)
                <th class="right" style="width:10%;">Coût</th>
            @endif
    ...
    <tbody>
        ...
        @empty
            <tr><td colspan="{{ $canViewCost ? 9 : 8 }}">Aucun article pour ces filtres.</td></tr>
        @endforelse
    </tbody>
</table>

<div class="footer">
    {{ $shopName }} · Généré le {{ $generatedAt->format('d/m/Y à H:i') }} · {{ $title ?? 'Catalogue' }}
</div>
</body>
</html>
