@props([
    'tone' => 'teal', // teal | blue | green | amber | rose | violet
    'icon' => 'document',
])
...
@php
    $paths = [
        ...
        'credit-card' => 'M3 10h18M5 6h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z',
...
<span {{ $attributes->class(['ui-icon-box', 'ui-icon-box--' . $tone]) }}>
